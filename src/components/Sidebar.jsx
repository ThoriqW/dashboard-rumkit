          ...
          <ul className="space-y-2 font-medium">
            ...
            <li>
              ...
              >
                ...
                <span className="ms-3">Rawat Jalan</span>
              </NavLink>
            </li>
            <li>
              <NavLink
              ...
              >
                ...
                <span className="ms-3">Rawat Inap</span>
              </NavLink>
            </li>
            <li>
              <NavLink
              ...
              >
                ...
                <span className="ms-3">Farmasi</span>
              </NavLink>
            </li>
            <li>
              <NavLink
            ...
            <li>
              ...
              >
                ...
                <span className="ms-3">Radiologi</span>
              </NavLink>
            </li>
            <li>
              <button
