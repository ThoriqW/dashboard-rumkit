...
export const getDataRalanDashboard = async (startDate, endDate, setPasienRalan, setseriesDataRalan, setCategories) => {
    authToken();
    try {
 ...
 export const getDataRanapDashboard = async (startDate, endDate, setPasienRanap, setseriesDataRanap, setCategories) => {
    authToken();
    try {
      const savedAuth = Cookies.get("auth");
      const { data } = JSON.parse(savedAuth);
